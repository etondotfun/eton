...
const CardReferral = ({
  ...
  return (
    <div className="w-[80%] flex flex-col gap-1 abril">
      <div className="bg-tonprimary rounded-2xl py-3 px-6">
        <div className="text-center flex flex-col items-center">
          <div className="text-4xl text-primary font-bold">
            Earn{" "}
            <span className="text-6xl text-textColor font-extrabold">1%</span>{" "}
            of each trade
          </div>
          <div className="text-gray-300 font-medium text-xl">
      ...
      <div className="bg-tonprimary rounded-2xl py-3 px-6">
        <div className="flex justify-center items-center gap-2">
          <div className="text-primary">{reflink}</div>
          <button
      ...
      <div className="flex justify-between items-center text-center w-full">
        <div className="flex flex-col gap-2 w-[33%] bg-tonprimary rounded-2xl p-6">
